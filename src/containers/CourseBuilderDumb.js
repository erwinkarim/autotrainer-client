...
import {
  Container, Row, Col, Breadcrumb, BreadcrumbItem, Nav, NavItem, NavLink, TabContent,
  TabPane, Navbar, Jumbotron, FormGroup, Label, InputGroup, Input, InputGroupAddon,
  InputGroupText, Button, FormText, UncontrolledDropdown, DropdownToggle, DropdownMenu,
  DropdownItem, Alert, CardColumns, CardDeck, Card, CardBody, CardTitle,
  CardText, Collapse,
} from 'reactstrap';
...
const CourseForm = (props) => {
  ...
  const bg_styling = props.bg_pic_data ?
    {backgroundImage:`url(${props.bg_pic_data})`, backgroundRepeat:'no-repeat', backgroundSize:'cover'} :
    {};
  const title_font_styling = props.course.title_font_color ?
    { color:props.course.title_font_color} : {color:'black'};
  let styling = Object.assign({}, bg_styling);
  styling = Object.assign(styling, title_font_styling);

  const bg_file_name = props.bg_handle ?
    (props.bg_handle instanceof Object ? props.bg_handle.name : props.bg_handle) :
    '' ;
  ...
  return (<div>
      ...
      <h1 className="text-center">
        <InputGroup>
          <Input type="text" placeholder="Course Name. Should be less than 140 characters"
            ...
            maxLength="140" id="name" value={props.course.name} onChange={props.handleChange} />
    ...
    <FormGroup>
      ...
      <Input type="select"
        id="title_font_color" value={props.course.title_font_color} onChange={props.handleChange}>
    ...
    <FormGroup>
      ...
      {
        props.course.bg_pic ? <Input disabled={true} value={bg_file_name} /> : null
      }
    </FormGroup>
    <p>Preview</p>
      ...
      <Label>Tagline</Label>
        <InputGroup>
          <Input type="text" placeholder="Tag Line. Should be less than 140 characters" id="tagline"
            ...
            maxLength="140" value={props.course.tagline} onChange={props.handleChange} />
                  ...
                  <FormGroup>
                    <h4>
                      <InputGroup className="mb-2">
                        <Input type="text" placeholder={`Title for Point ${i+1}. Should be less than 70 characters`}
                          ...
                          value={e.title} onChange={props.handleChange}
                        />
                        <InputGroupAddon addonType="append" className="text-muted">
                    ...
                    <InputGroup className="mb-2">
                      <Input type="textarea" placeholder={`Subtext for Point ${i+1}. Should be less than 140 characters`}
                        ...
                        value={e.subtext} onChange={props.handleChange}
                      />
                      <InputGroupAddon addonType="append" className="text-muted">
    ...
    <div>
      ...
      <ClientTestimonials toggleCompany={props.toggleCompany} clientList={props.course.clientList}/>
    </div>
...
export default class CourseBuilder extends Component {
  ...
  getCourse = () => {
    return invokeApig({path:`/courses/${this.props.match.params.courseId}`})
  }
