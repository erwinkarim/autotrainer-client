  ...
  render = () => {
    ...
    if (this.props.enrolment.certId) {
      ...
      completedTimelineElm = (
        ...
        >
          ...
          <p>Completion Date: {certCompleteDateCaption}</p>
        </VerticalTimelineElement>
      );
    }
    ...
    return (
      <div>
        <Jumbotron fluid>
          <Container>
            <h4 className="display-4">Course Progress</h4>
            <p className="lead">How are you doing so far ...</p>
          </Container>
        </Jumbotron>
        <Container className="text-left">
          <Row>
            <Col xs="12" md="8" style={{ backgroundColor: 'gainsboro' }}>
              <VerticalTimeline>
                {
